<?php
	...
	{
		if ($_COOKIE['promPass'] !== 'HASHED_PASSWORD_HERE')
		{
	...
	{
		if (sha1($_POST['promPass']) !== 'HASHED_PASSWORD_HERE')
...
<!--[if gt IE 8]><!--> <html class="no-js"> <!--<![endif]-->
    ...
    <form id="frmProm" name="frmProm" class="wufoo topLabel page" autocomplete="off" enctype="multipart/form-data" method="post" novalidate action="javascript:void(0);">
            ...
            <ul>
                ...
                <label class="desc" id="title1" for="Field1">Student Name<span id="req_1" class="req">*</span></label>
            <span>
